        ...
        <div className="w-[100%] md:h-[100%] h-[55vh] bg-transparent md:ml-8 ml-4 items-center flex">
          <div className="w-[90%] h-[90%] text-white">
            <div className="w-[60%] h-[98%]">
              <h1 className="md:pt-80 mt-14 font-medium md:text-4xl text-2xl">
              ...
              <div className="gap-10 flex md:mt-3 mt-2">
                <button className="hover:bg-yellow-700 md:w-56 md:h-14 w-36 h-10 rounded-lg border border-black justify-center items-center flex cursor-pointer bg-orange-400 text-black">
