    ...
    <div>
        <div className='w-full md:h-[100vh] h-[100%]'>
            ...
            <div className="md:pt-10 pt-4 justify-center">
                ...
                <p className="font-medium font-mono md:text-[30px] text-lg justify-center items-center flex">Discover the difference a touch of perfection can make</p>
                <p className="font-medium font-mono md:text-[30px] text-lg justify-center items-center flex">We are located at Pacific Mall Ilasan</p>
                <p className="font-medium font-mono md:text-[30px] text-lg justify-center items-center flex">32 Ilasan new road Lekki Lagos</p>
            </div>
