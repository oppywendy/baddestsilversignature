...
const Explore = () => {
  return (
    <div className="w-full justify-center items-center flex md:pt-28 pt-10 md:pb-20 font-poppins bg-black">
      <div className="lg:w-[80%] w-full lg:h-[70vh] max-h-full bg-black justify-center items-center flex md:rounded-3xl text-white">
        <div className="flex w-[100%] h-[100%] rounded-3xl flex-col lg:flex-row">
          <div className="lg:w-[50%] w-full lg:h-[100%] h-[45%]">
            ...
            <div className="justify-center items-center grid lg:pt-14 md:pt-10 pt-8">
              <button className="w-48 h-12 rounded-lg hover:bg-[#b8922f] justify-center items-center flex cursor-pointer bg-[#d4af37] text-black">
          ...
          <div className="lg:w-[50%] md:w-[100%] w-full lg:h-[100%] h-[55%] justify-center items-center flex top-10 pt-10 lg:pt-0">
            <div className="justify-center items-center flex">
              <img
                className="md:w-[400px] w-[450px] h-[300px] md:rounded-2xl"
                src={pic}
                alt=""
              />
            </div>
