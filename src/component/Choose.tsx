  ...
  return (
    <div className="w-[100%] md:h-[80vh] h-[70vh] justify-center md:items-center flex">
      <div className="w-[96%] md:h-[95%] h-[70vh] flex justify-center md:items-center flex-col md:flex-row">
        <div className="md:w-[50%] w-full md:h-[90%] h-[15vh] items-center justify-center flex">
          <h1 className="font-serif md:text-5xl text-4xl font-bold">
            Why Choose Us?
          </h1>
        </div>
        <div className="md:w-[50%] md:h-[90%] h-[50vh]">
          ...
          <div className="md:pl-32 pl-16">
            <button className="w-60 h-12 rounded-lg border border-black justify-center items-center flex cursor-pointer bg-yellow-500 hover:bg-yellow-700 text-black">
