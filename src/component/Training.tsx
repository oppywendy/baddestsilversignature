        ...
        <div className='w-[96%] h-[98%]'>
           ...
           <div className=' w-[98%] md:h-[85%] h-[98%] flex justify-center items-center flex-col-reverse md:flex-row'>
            ...
            <div className='md:w-[70%] w-full md:h-[98%] h-[85%] pt-1 flex justify-center'>
                ...
                <img className="md:w-60 w-[240px] md:h-[80vh] h-[380px] md:mt-10" src={pic3} alt="" />
                <img className="md:w-60 w-[240px] md:h-[80vh] h-[380px] md:mt-20" src={pic2} alt="" />
                <img className="md:w-60 w-[240px] md:h-[80vh] h-[380px] md:mt-2" src={pic} alt="" />
                </div>
            </div>
            </div>
           </div>
