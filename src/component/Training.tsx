  ...
  return (
    <div className="w-full max-h-full bg-[#F8FAFD] justify-center items-center flex">
      <div className="w-[96%] h-[98%]">
        <h1 className="font-medium lg:text-5xl md:text-4xl text-3xl font-serif text-center lg:pt-5 md:pt-4 pt-5 pb-3">
          GROOMING EXPERIENCE
        </h1>
        <div className="lg:justify-center lg:items-center lg:pt-7 flex h-[98%]">
          <div className=" w-[100%] lg:h-[85%] h-[98%] flex justify-center items-center flex-col-reverse lg:flex-row">
            <div className="lg:w-[30%] mb-5 w-full lg:h-[98%] md:h-[20vh] lg:pt-5 md:pt-5 pt-3 flex-wrap items-center grid">
              <div className="h-[100%]">
                <h1 className="md:h-[50%] lg:text-5xl md:text-5xl text-lg text-center font-bold justify-center md:items-end grid">
                  Enrol for your Training session
                </h1>
                <div className="md:h-[50%] justify-center md:items-start grid lg:pt-10 md:pt-5 pt-3">
                  <button className="lg:w-48 md:w-44 w-32 lg:h-12 md:h-16 h-9 rounded-r-full rounded-l-full border border-black hover:bg-blue-950 justify-center items-center flex cursor-pointer bg-black text-yellow-500 md:text-2xl">
