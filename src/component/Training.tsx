        ...
        <div className='w-[96%] h-[98%]'>
           ...
           <div className=' w-[98%] md:h-[85%] h-[98%] flex justify-center items-center flex-col-reverse md:flex-row'>
            <div className='md:w-[30%] w-full md:h-[98%] pt-5 flex-wrap items-center md:grid md:grid-cols-2 flex'>
                ...
                <div className=' md:pt-14 pt-5'><button className='w-48 h-12 rounded-r-full rounded-l-full border border-black hover:bg-slate-300 justify-center items-center flex cursor-pointer bg-[#EAB308] text-black'><a href="https://wa.me/2349091737314">Sign Up</a><div className='pl-2 justify-center items-center flex'><FaArrowRight /></div></button></div>
            </div>
